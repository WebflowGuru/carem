...
const validCombinations = [
  ...
  { year: 2018, make: "Hyundai", model: "Model" },
  {
    year: 2018,
    make: "Hyundai",
    model: "Ioniq Plug-In Hybrid Electric Vehicle",
  },
...
function checkCombination() {
  ...
  isCombinationValid ? (cominations = 2) : (cominations = 3);
  ...
  if (document.querySelectorAll(".clicked").length == 2) {
    if (isCombinationValidButton) {
      // alert("Combination is valid!");
      qualificationBadge.textContent = "You Appear to Qualify";
      qualificationBadge.style.backgroundColor = "rgb(134, 191, 139)";
    } else {
      qualificationBadge.textContent = "You Don't Appear to Qualify";
...
function qualificationBadgeChanged() {
  ...
  console.log("cominations", cominations);

  console.log(isCombinationValidButton && cominations == 2);

  if (!(cominations == 1)) {
    if (isCombinationValidButton && cominations == 2) {
      qualificationBadge.textContent = "You Appear to Qualify";
      qualificationBadge.style.backgroundColor = "rgb(134, 191, 139)";
    } else {
      qualificationBadge.textContent = "You Don't Appear to Qualify";
